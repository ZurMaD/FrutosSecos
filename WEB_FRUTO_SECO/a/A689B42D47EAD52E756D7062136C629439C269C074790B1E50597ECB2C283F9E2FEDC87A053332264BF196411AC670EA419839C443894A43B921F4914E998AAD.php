      ...
      <main class="s-home s-home--particles">
         ...
         <div class="home-content">
            ...
            <div class="row home-content__main">
                  ...
                  <table>
                     ...
                     <form>
                        <!-- 
                          ...
                          -->
                          <input style="background-color: #00FF00;font-size: 12px;border: none"type="button" value="M1=1" onclick="window.open('prender1.php?id=1&m1=1');" />
                        <input style="background-color: #00FF00;font-size: 12px;border: none"type="button" value="M2=1" onclick="window.open('prender2.php?id=1&m2=1');" />
                        <input style="background-color: #00FF00;font-size: 12px;border: none"type="button" value="M3,4,5=1" onclick="window.open('prender3.php?id=1&m3=1');" />
                        <input style="background-color: #e3ff00;font-size: 12px;border: none"type="button" value="INICIAR=1" onclick="window.open('prender.php?id=1&p=1');" />
                        <input style="background-color: #00ecff;font-size: 12px;border: none"type="button" value="SIN FUNCIONAR" onclick="window.open('detener.php?id=1&d=1');" />
                        </form>
                     </td>
                     <td>                        
                     <form>
                        ...
                        -->
                         ...
                         <input style="background-color: #00FF00;font-size: 12px;border: none"type="button" value="M1=0" onclick="window.open('prender1.php?id=1&m1=0');" />
                        <input style="background-color: #00FF00;font-size: 12px;border: none"type="button" value="M2=0" onclick="window.open('prender2.php?id=1&m2=0');" />
                        <input style="background-color: #00FF00;font-size: 12px;border: none"type="button" value="M3,4,5=0" onclick="window.open('prender3.php?id=1&m3=0');" />
                        <input style="background-color: #e3ff00;font-size: 12px;border: none"type="button" value="INICIAR=0" onclick="window.open('prender.php?id=1&p=0');" />
                        <input style="background-color: #00ecff;font-size: 12px;border: none"type="button" value="SIN FUNCIONAR" onclick="window.open('detener.php?id=1&d=0');" />
                      </form>
                     </td>
                     <td>
               ...
               <div class="col-four home-content__counter">
                  ...
                  <div id="scores">
                    ...
                    <!-- <h1>Activar visualización  js y html</h1>  -->
            ...
            <div class="row home-copyright">
               ...
               <span>Diseñado por <a href="http://www.Styleshout.com">Styleshout</a></span>
            </div>
            <!-- end home-copyright -->
